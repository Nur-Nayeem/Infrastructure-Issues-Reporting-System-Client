...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-center whitespace-nowrap border-b border-solid border-slate-800/80 bg-background-dark/80 px-4 md:px-10 py-4 backdrop-blur-md">
      <div className="flex items-center justify-between w-full max-w-7xl">
        {/* Logo uses Link, as it's the root navigation */}
