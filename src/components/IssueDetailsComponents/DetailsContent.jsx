...
const DetailsContent = ({ issue, handleUpvote, isAlreadyVoted }) => {
  return (
    <div className="p-6 md:p-8">
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="flex flex-col w-max items-center justify-center bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl p-3 min-w-16 transition-all group"
        >
          {isAlreadyVoted ? (
